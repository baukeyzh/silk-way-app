...
<div class="space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">{{ translate('my_applications.heading') }}</h1>
            <p class="mt-2 text-sm sm:text-base text-gray-700">
                {{ translate('my_applications.description') }}
            </p>
        </div>
        <div class="mt-4 sm:mt-0">
            <a href="{{ route('cargo.index') }}" 
               class="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:w-auto transition duration-200">
                ...
                {{ translate('my_applications.view_cargo_button') }}
            </a>
        </div>
    </div>
                    ...
                    <div class="ml-4 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">
                                {{ translate('my_applications.stats_pending') }}
                            </dt>
            ...
            <div class="p-4 sm:p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">
                                {{ translate('my_applications.stats_approved') }}
                            </dt>
                            <dd class="text-lg font-medium text-gray-900">
            ...
            <div class="p-4 sm:p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">
                                {{ translate('my_applications.stats_rejected') }}
                            </dt>
                            <dd class="text-lg font-medium text-gray-900">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-200">
            <h2 class="text-lg sm:text-xl font-semibold text-gray-900 flex items-center">
                ...
                {{ translate('my_applications.pending_title') }} ({{ $pendingApplications->count() }})
            </h2>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                {{ translate('my_applications.table_route') }}
                            </th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                {{ translate('my_applications.table_cargo') }}
                            </th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                {{ translate('my_applications.table_submitted') }}
                            </th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                {{ translate('my_applications.table_actions') }}
                            </th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $application->cargo->cargo_type }}</div>
                                <div class="text-sm text-gray-500">{{ $application->cargo->volume }} м³, {{ $application->cargo->weight }} кг</div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('my-cargo.applications.show-from-my-cargo', $application) }}" 
                                   class="text-blue-600 hover:text-blue-900 transition duration-200">
                                    ...
                                    {{ translate('my_applications.view_details') }}
                                </a>
                            </td>
                        </tr>
                        @endforeach
            ...
            <div class="p-4 sm:p-6">
                <div class="flex justify-between items-start mb-3">
                    ...
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                        ...
                        {{ translate('my_applications.status_pending') }}
                    </span>
                </div>
                
                <div class="grid grid-cols-2 gap-4 mb-4 text-sm">
                    <div>
                        <span class="text-gray-500">{{ translate('my_applications.volume_label') }}</span>
                        <span class="font-medium">{{ $application->cargo->volume }} м³</span>
                    </div>
                    <div>
                        <span class="text-gray-500">{{ translate('my_applications.weight_label') }}</span>
                        <span class="font-medium">{{ $application->cargo->weight }} кг</span>
                    </div>
                    <div>
                        <span class="text-gray-500">{{ translate('my_applications.submitted_label') }}</span>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-200">
            <h2 class="text-lg sm:text-xl font-semibold text-green-700 flex items-center">
                ...
                {{ translate('my_applications.approved_title') }} ({{ $approvedApplications->count() }})
            </h2>
        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $application->cargo->cargo_type }}</div>
                                <div class="text-sm text-gray-500">{{ $application->cargo->volume }} м³, {{ $application->cargo->weight }} кг</div>
                                <div class="text-sm text-gray-500">Подтверждено: {{ $application->approved_at->format('d.m.Y H:i') }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-200">
            <h2 class="text-lg sm:text-xl font-semibold text-red-700 flex items-center">
                ...
                {{ translate('my_applications.rejected_title') }} ({{ $rejectedApplications->count() }})
            </h2>
        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-sm text-gray-500">Ваши заметки: {{ $application->driver_notes }}</div>
                                @endif
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('my-cargo.applications.show-from-my-cargo', $application) }}" 
            ...
            <div class="p-4 sm:p-6">
                <div class="flex justify-between items-start mb-3">
                    ...
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                        ...
                        {{ translate('my_applications.status_rejected') }}
                    </span>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4 text-sm">
                    ...
                    <div class="col-span-2">
                        <span class="text-gray-500">{{ translate('my_applications.driver_notes_label') }}</span>
                        <span class="font-medium">{{ $application->driver_notes }}</span>
                    </div>
                    @endif
                </div>
    ...
    <div class="text-center py-12">
        ...
        <h3 class="text-xl font-semibold text-gray-600 mb-2">{{ translate('my_applications.no_applications_title') }}</h3>
        <p class="text-gray-500 mb-6">{{ translate('my_applications.no_applications_desc') }}</p>
        <a href="{{ route('cargo.index') }}" 
           class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200">
            <i class="fas fa-box mr-2"></i>
            {{ translate('my_applications.view_available_cargo') }}
        </a>
    </div>
    @endif
    ...
    <div class="mt-8 pt-6 border-t border-gray-200">
        <button type="button" 
            ...
            {{ translate('my_applications.back_button') }}
        </button>
    </div>
</div>
@endsection 