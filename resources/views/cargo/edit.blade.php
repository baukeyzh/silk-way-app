...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div class="flex-1">
            ...
            <p class="text-sm text-slate-500 mt-0.5">{{ translate('cargo.edit_desc') }}</p>
        </div>
    </div>
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div class="sm:col-span-2">
                        <label for="cargo_type" class="block text-sm font-medium text-slate-700 mb-1.5">{{ translate('cargo.cargo_type') }}</label>
                        <input type="text" name="cargo_type" id="cargo_type"
                               class="block w-full px-3 py-2.5 rounded-lg border border-slate-300 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('cargo_type') border-rose-400 @enderror"
                               value="{{ old('cargo_type', $cargo->cargo_type) }}" required>
                        @error('cargo_type')<p class="mt-1 text-xs text-rose-600">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label for="volume" class="block text-sm font-medium text-slate-700 mb-1.5">{{ translate('cargo.volume') }}</label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="weight" class="block text-sm font-medium text-slate-700 mb-1.5">{{ translate('cargo.weight') }}</label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="price_usd" class="block text-sm font-medium text-slate-700 mb-1.5">{{ translate('cargo.price_usd') }}</label>
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" min="0" name="price_usd" id="price_usd"
                                   class="block w-full pl-8 pr-3 py-2.5 rounded-lg border border-slate-300 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                   value="{{ old('price_usd', $cargo->price_usd) }}" placeholder="0.00">
                        </div>
                    </div>

                    <div>
                        <label for="ready_date" class="block text-sm font-medium text-slate-700 mb-1.5">{{ translate('cargo.ready_date') }}</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            <div class="flex items-center justify-end gap-3">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i>{{ translate('cargo.update_cargo') }}
                </button>
            </div>
        </div>
    </form>
