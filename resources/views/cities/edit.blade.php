...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Редактировать город</h1>
            <p class="text-sm text-slate-500 mt-0.5">{{ $city->name_rus }}</p>
        </div>
    </div>
        ...
        <form action="{{ route('cities.update', $city) }}" method="POST">
                ...
                <div class="border-t border-slate-100 pt-5">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name_rus" id="name_rus" value="{{ old('name_rus', $city->name_rus) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="name_kaz" id="name_kaz" value="{{ old('name_kaz', $city->name_kaz) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="name_chn" id="name_chn" value="{{ old('name_chn', $city->name_chn) }}" required
            ...
            <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                <form action="{{ route('cities.destroy', $city) }}" method="POST">
                    ...
                    @method('DELETE')
                    <button type="submit"
                            class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-rose-700 bg-rose-50 border border-rose-200 rounded-lg hover:bg-rose-100 transition-colors"
