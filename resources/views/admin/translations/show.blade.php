        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-xl font-semibold text-gray-900">{{ $translation->key }}</h2>
                ...
                <div class="mt-8 pt-6 border-t border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-900">{{ ucfirst($translation->group) }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Создан</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $translation->created_at->format('d.m.Y H:i:s') }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Обновлен</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $translation->updated_at->format('d.m.Y H:i:s') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 pt-6 border-t border-gray-200">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="bg-gray-900 text-green-400 p-3 rounded font-mono text-sm overflow-x-auto">
                            ...
                            <span class="text-yellow-400">{{ '{{ __(' . "'" . $translation->key . "'" . ') }}' }}</span><br><br>
                            <span class="text-gray-400">// В контроллере:</span><br>
                            <span class="text-yellow-400">__('{{ $translation->key }}')</span><br><br>
                            <span class="text-gray-400">// В хелпере:</span><br>
                            <span class="text-yellow-400">LocalizationHelper::t('{{ $translation->key }}')</span>
                        </div>
                    </div>
                </div>
            </div>
