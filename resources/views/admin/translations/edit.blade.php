                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <textarea id="ru" 
                                  ...
                                  placeholder="Введите перевод на русском языке">{{ old('ru', $translation->ru) }}</textarea>
                        @error('ru')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="kz" 
                                  ...
                                  placeholder="Введите перевод на казахском языке">{{ old('kz', $translation->kz) }}</textarea>
                        @error('kz')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="cn" 
                                  ...
                                  placeholder="Введите перевод на китайском языке">{{ old('cn', $translation->cn) }}</textarea>
                        @error('cn')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
