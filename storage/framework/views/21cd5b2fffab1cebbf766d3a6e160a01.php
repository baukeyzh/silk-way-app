<?php $__env->startSection('title', 'Мои машины'); ?>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition duration-200 cursor-pointer car-row" 
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e($car->max_weight); ?> тонн
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
            ...
            <div class="bg-white shadow rounded-lg p-4 hover:shadow-md transition duration-200 cursor-pointer car-card" 
                ...
                <div class="grid grid-cols-2 gap-4 mb-4 text-sm">
                    <div>
                        ...
                        <span class="font-medium"><?php echo e($car->max_weight); ?> тонн</span>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <span class="font-medium"><?php echo e($car->trailer_volume); ?> м³</span>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/zhandosbaukei/Desktop/projects/silk-way/silk-way-app/resources/views/cars/my-cars.blade.php ENDPATH**/ ?>