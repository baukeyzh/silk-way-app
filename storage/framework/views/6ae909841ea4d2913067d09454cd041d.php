<?php $__env->startSection('title', \App\Helpers\LocalizationHelper::t('admin.dashboard_title') . ' - Silk Way'); ?>
...
<div class="space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e(\App\Helpers\LocalizationHelper::t('admin.dashboard_title')); ?></h1>
            <p class="mt-2 text-sm sm:text-base text-gray-700">
                <?php echo e(\App\Helpers\LocalizationHelper::t('admin.dashboard_desc')); ?>
        ...
        <div class="mt-4 sm:mt-0">
            <a href="<?php echo e(route('admin.translations.index')); ?>" 
               class="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-200">
                ...
                <?php echo e(\App\Helpers\LocalizationHelper::t('admin.translations')); ?>
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">
                                <?php echo e(translate('admin.total_cargo')); ?>

                            </dt>
                            <dd class="text-lg font-medium text-gray-900">
                                <?php echo e($cargoStats['total']); ?>
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">
                                <?php echo e(translate('admin.available_cargo')); ?>

                            </dt>
                            <dd class="text-lg font-medium text-gray-900">
                                <?php echo e($cargoStats['available']); ?>
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">
                                <?php echo e(translate('admin.picked_up_cargo')); ?>

                            </dt>
                            <dd class="text-lg font-medium text-gray-900">
                                <?php echo e($cargoStats['picked_up']); ?>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">
                    <?php echo e(translate('admin.pending_users')); ?> (<?php echo e($pendingUsers->count()); ?>)
                </h3>
                <p class="mt-1 max-w-2xl text-sm text-gray-500">
                    <?php echo e(translate('admin.pending_users_desc')); ?>
                                ...
                                <div class="ml-4">
                                    <div class="flex items-center">
                                        ...
                                        <span class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                            <?php echo e($user->role === 'warehouse_employee' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'); ?>">
                                            <?php echo e($user->role === 'warehouse_employee' ? translate('auth.warehouse_employee') : translate('auth.driver_role')); ?>

                                        </span>
                                    </div>
                                    <p class="text-sm text-gray-500"><?php echo e($user->email); ?></p>
                                    <p class="text-xs text-gray-400"><?php echo e(translate('admin.registered_at')); ?>: <?php echo e($user->created_at->format('d.m.Y H:i')); ?></p>
                                </div>
                            </div>
    ...
    <div class="mt-8">
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">
                    <?php echo e(translate('admin.approved_users')); ?> (<?php echo e($approvedUsers->count()); ?>)
                </h3>
                <p class="mt-1 max-w-2xl text-sm text-gray-500">
                    <?php echo e(translate('admin.approved_users_desc')); ?>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                        ...
                                        <p class="text-sm font-medium text-gray-900">
                                            ...
                                            <?php if($user->isAdmin()): ?>
                                                <span class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                                    <?php echo e(translate('admin.administrator')); ?>
                                    ...
                                    <p class="text-sm text-gray-500"><?php echo e($user->email); ?></p>
                                    <p class="text-xs text-gray-400"><?php echo e(translate('admin.approved_at')); ?>: <?php echo e($user->updated_at->format('d.m.Y H:i')); ?></p>
                                </div>
                            </div>
                            <?php if(!$user->isAdmin()): ?>
                            <div class="flex space-x-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/zhandosbaukei/Desktop/projects/silk-way/silk-way-app/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>