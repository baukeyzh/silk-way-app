...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('add_translation')); ?></h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['key'];
...
unset($__errorArgs, $__bag); ?>"
                               placeholder="Введите ключ перевода (например: welcome_message)">
                        <?php $__errorArgs = ['key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($group); ?>" <?php echo e(old('group') == $group ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="Опишите, для чего используется этот перевод"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="Введите перевод на русском языке"><?php echo e(old('rus')); ?></textarea>
                        <?php $__errorArgs = ['rus'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="Введите перевод на казахском языке"><?php echo e(old('kaz')); ?></textarea>
                        <?php $__errorArgs = ['kaz'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="Введите перевод на китайском языке"><?php echo e(old('chn')); ?></textarea>
                        <?php $__errorArgs = ['chn'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/zhandosbaukei/Desktop/projects/silk-way/silk-way-app/resources/views/admin/translations/create.blade.php ENDPATH**/ ?>