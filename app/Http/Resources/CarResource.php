 ...
 *     @OA\Property(property="vehicle_document", type="string",  nullable=true, example="https://example.com/storage/doc.pdf"),
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'vehicle_document' => $this->vehicle_document
                ? Storage::disk('public')->url($this->vehicle_document)
                : null,
